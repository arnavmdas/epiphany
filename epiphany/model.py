...
#         # self.conv1_1 = nn.Conv2d(1, 10, 15, stride=1, padding=7)
#         # self.act1_1 = nn.ReLU()
#         # self.conv1_2 = nn.Conv2d(1, 10, 5, stride=1, padding=2)
#         # self.act1_2 = nn.ReLU()

#         self.conv1_1 = nn.Conv2d(1, 2, 21, stride=1, padding=10)
#         self.act1_1 = nn.ReLU()
#         self.conv1_2 = nn.Conv2d(1, 20, 5, stride=1, padding=2)
#         self.act1_2 = nn.ReLU()
#         self.conv1_3 = nn.Conv2d(1, 4, 11, stride=1, padding=5)
#         self.act1_3 = nn.ReLU()
...
#         self.conv2 = nn.Conv2d(26, 25, 5, stride=1)
#         self.act2 = nn.ReLU()
...
#         self.fc1 = nn.Linear(6480, 1)

#     def forward(self, x):

#         out1 = self.conv1_1(x)
#         out1 = self.act1_1(out1)
#         out2 = self.conv1_2(x)
#         out2 = self.act1_2(out2)
#         out3 = self.conv1_3(x)
#         out3 = self.act1_3(out3)
